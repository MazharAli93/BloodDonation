...
import 'admin_request_info_model.dart';
export 'admin_request_info_model.dart';

class AdminRequestInfoWidget extends StatefulWidget {
  const AdminRequestInfoWidget({
    super.key,
  ...
  @override
  State<AdminRequestInfoWidget> createState() => _AdminRequestInfoWidgetState();
}

class _AdminRequestInfoWidgetState extends State<AdminRequestInfoWidget> {
  late AdminRequestInfoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AdminRequestInfoModel());
