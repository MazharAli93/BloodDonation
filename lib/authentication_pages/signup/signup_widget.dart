                                  ...
                                  if (_model.pageViewCurrentIndex.toString() ==
                                    ...
                                    safeSetState(() {
                                      _model.genderDropDownValueController
                                          ?.reset();
                                      _model.bloodTypeDropDownValueController
                                          ?.reset();
                                    ...
                                    safeSetState(() {
                                      ...
                                      _model.middleNameTextController?.clear();
                                      _model.lastNameTextController?.clear();
                                      _model.motherNameTextController?.clear();
                                      ...
                                      children: [
                                        ...
                                        Padding(
                                          padding:
                                              const EdgeInsetsDirectional.fromSTEB(
                                                  0.0, 0.0, 0.0, 20.0),
                                          child: FutureBuilder<List<TownRow>>(
                                        ...
                                        FFButtonWidget(
                                          onPressed: () async {
                                            ...
                                            if (_model.bloodTypeDropDownValue ==
                                                null) {
                                              return;
                                            }
                                            ...
                                            if (_model.cityDropDownValue ==
                                                null) {
                                              return;
                                            }
                                            if (_model.townDropDownValue ==
                                                null) {
                                              return;
                                            }
