...
import 'schema/district_record.dart';
import 'schema/city_record.dart';
import 'schema/town_record.dart';
...
export 'schema/district_record.dart';
export 'schema/city_record.dart';
export 'schema/town_record.dart';
...
/// Functions to query DistrictRecords (as a Stream and as a Future).
Future<int> queryDistrictRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      DistrictRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<DistrictRecord>> queryDistrictRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      DistrictRecord.collection,
      DistrictRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<DistrictRecord>> queryDistrictRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
/// Functions to query TownRecords (as a Stream and as a Future).
Future<int> queryTownRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      TownRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<TownRecord>> queryTownRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      TownRecord.collection,
      TownRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<TownRecord>> queryTownRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
